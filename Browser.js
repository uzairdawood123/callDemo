...
import arrowNextIcon from './assets/arrow_back.png';
import webIcon from './assets/arrow_back.png';
import refreshIcon from './assets/arrow_back.png';
import incognitoIcon from './assets/arrow_back.png';
...
class Browser extends Component {
  ...
  onBrowserError = (syntheticEvent) => {
    ...
    console.warn('WebView error: ', nativeEvent.message)
  };
